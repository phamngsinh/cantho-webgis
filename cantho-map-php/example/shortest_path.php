...
<script type="text/javascript" defer="defer">
	...
	function call_Shortest_Path()
	{
		...
		pl.add('start_x',586090.23521);
		pl.add('start_y',1111493.95478);
		pl.add('end_x',586488.68419);
		pl.add('end_y',1110270.51207);
		SOAPClient.invoke(url, "find_Shortest_Path", pl, true, shortest_Path_CallBack);
	} 

...
function stoptimer_coquan(){
	clearTimeout(timer_coquan);
	document.getElementById("coquan").style.color="blue";
}
...
function stoptimer_truonghoc(){
	clearTimeout(timer_truonghoc);
	document.getElementById("truonghoc").style.color="blue";
}
...
function stoptimer_benhvien(){
	clearTimeout(timer_benhvien);
	document.getElementById("benhvien").style.color="blue";
}
...
function stoptimer_cho(){
	clearTimeout(timer_cho);
	document.getElementById("cho").style.color="blue";
}
...
function stoptimer_bentauxe(){
	clearTimeout(timer_bentauxe);
	document.getElementById("bentauxe").style.color="blue";
}
...
function stoptimer_khachsan(){
	clearTimeout(timer_khachsan);
	document.getElementById("khachsan").style.color="blue";
}
...
function stoptimer_congty(){
	clearTimeout(timer_congty);
	document.getElementById("congty").style.color="blue";
}
...
function stoptimer_giaitri(){
	clearTimeout(timer_giaitri);
	document.getElementById("giaitri").style.color="blue";
}
...
function stoptimer_denchua(){
	clearTimeout(timer_denchua);
	document.getElementById("denchua").style.color="blue";
}
...
function stoptimer_truyenthong(){
	clearTimeout(timer_truyenthong);
	document.getElementById("truyenthong").style.color="blue";
}
...
function stoptimer_nganhang(){
	clearTimeout(timer_nganhang);
	document.getElementById("nganhang").style.color="blue";
}
...
function stoptimer_congvien(){
	clearTimeout(timer_congvien);
	document.getElementById("congvien").style.color="blue";
}
...
function stoptimer_cau(){
	clearTimeout(timer_cau);
	document.getElementById("cau").style.color="blue";
}
...
function stoptimer_thuvien(){
	clearTimeout(timer_thuvien);
	document.getElementById("thuvien").style.color="blue";
}
...
function stoptimer_khac(){
	clearTimeout(timer_khac);

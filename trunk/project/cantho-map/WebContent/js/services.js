...
/**Khi co loi xay ra: tao duong thang noi truc tiep giua start_point va end_point
 * Hien thi duong thang vua tao va tinh do dai cua no
 * Xoa cac feature tren lop_duong_di
 * **/
function errorGetDuongDi(xml_error) {
	...
	if (num_points==2){
		...
		line_string = new OpenLayers.Geometry.LineString([start_point,end_point]);
		//alert("line_string: "+line_string);
		//khoi tao doi tuong parser Well-Know-Text de doc chuoi linestring vua tao
...
function callBackGetDiaDiem(xml_result, status) {
	...
	var result = "<div class='SelectPlaceTitle' style='z-index: 848;'>" +
			             ...
			             "<span class='idiem-a-icon TitFlag'>A</span>" +
			      "</div>" +
			      "<br/> " +

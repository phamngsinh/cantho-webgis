...
function chonDiemA(i){
	...
	/**Neu so feature hien tai == 0 -> Them moi binh thuong
	 * Neu so feature hien tai == 1 or == 2 -> Dich chuyen feature dau tien den vi tri moi
	 * Them phan tu duoc chon vao vao o nhap diem A
	 * ***/
